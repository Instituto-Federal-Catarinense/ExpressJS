...
router.get('/', (req, res) => {
    ...
    const meusItens = [
      ...
      { id: 5, nome: 'Item Epilson', descricao: 'Mais um item para testar.' },
      { id: 6, nome: 'Item Zeta', descricao: 'Mais um item para testar.'},
      { id: 7, nome: 'Item Eta', descricao: 'Mais um item para testar.' },
      { id: 8, nome: 'Item Theta', descricao: 'Mais um item para testar.' },
      ...
      { id: 13, nome: 'Item Nu', descricao: 'Mais um item para testar.' },
      { id: 14, nome: 'Item Xi', descricao: 'Mais um item para testar.' },
      { id: 15, nome: 'Item Omicron', descricao: 'Mais um item para testar.'},
      ...
      { id: 20, nome: 'Item Upsilson', descricao: 'Mais um item para testar.' },
      { id: 21, nome: 'Item Phi', descricao: 'Mais um item para testar.'},
      { id: 22, nome: 'Item Chi', descricao: 'Mais um item para testar.' },
      { id: 23, nome: 'Item Psi', descricao: 'Mais um item para testar.' },
      { id: 24, nome: 'Item Omega', descricao: 'Mais um item para testar.'}
    ];
