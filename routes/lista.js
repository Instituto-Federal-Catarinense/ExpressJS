...
router.get('/', (req, res) => {
    ...
    const meusItens = [
      ...
      { id: 10, nome: 'Item Capa', descricao: 'Mais um item para testar.' },
      { id: 11, nome: 'Item Lambda', descricao: 'Mais um item para testar.' },
      { id: 12, nome: 'Item Mi', descricao: 'Mais um item para testar.' },
      { id: 13, nome: 'Item Ni', descricao: 'Mais um item para testar.' },
      { id: 14, nome: 'Item Csi', descricao: 'Mais um item para testar.' },
      { id: 15, nome: 'Item Ômicron', descricao: 'Mais um item para testar.' },
      { id: 16, nome: 'Item Pi', descricao: 'Mais um item para testar.' },
      { id: 17, nome: 'Item Rô', descricao: 'Mais um item para testar.' },
