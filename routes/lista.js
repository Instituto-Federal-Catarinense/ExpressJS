...
router.get('/', (req, res) => {
    ...
    const meusItens = [
      ...
      { id: 5, nome: 'Item Épsilon', descricao: 'Mais um item para testar2.' },
      { id: 6, nome: 'Item Zeta', descricao: 'Mais um item para testar3.' },
      { id: 7, nome: 'Item Eta', descricao: 'Mais um item para testar4.' },
      { id: 8, nome: 'Item Teta', descricao: 'Mais um item para testar5.' }
    ];
