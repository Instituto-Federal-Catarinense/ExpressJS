...
router.get('/', (req, res) => {
    ...
    const meusItens = [
      ...
      { id: 5, nome: 'Item Êpsilon', descricao: 'Eu adicionei esse item.' },
      { id: 6, nome: 'Item Zeta', descricao: 'Esse também.' },
      { id: 7, nome: 'Item Eta', descricao: 'E esse.' },
      { id: 8, nome: 'Item Teta', descricao: 'Juro que é o último.' }
    ];
